...
const mk = m(
  ...
  "Назад",
  {
    ...
    contact: { title: "Контакт", subtitle: "Помош од домаќинот" },
    arrival: { title: "Пристигнување", subtitle: "Влез и заминување" },
    house: { title: "Водич", subtitle: "За сместувањето" },
  ...
  },
  {
    ...
    helpSubtitle: "Wi-Fi, време за заминување, паркирање и локални совети.",
    promptSupermarket: "Каде е најблискиот супермаркет?",
    promptCheckout: "До кога треба да заминам?",
  ...
  },
  {
    ...
    arrival: { eyebrow: "Пристигнување", title: "Влез и заминување." },
    house: { eyebrow: "Водич", title: "Сè за сместувањето." },
  ...
  },
  {
    ...
    checkIn: "Влез во сместувањето",
    checkOut: "Заминување",
    checkInFallback: "Деталите за влез се во пораката за пристигнување.",
    checkOutFallback: "Деталите за заминување се во пораката за пристигнување.",
    parking: "Паркирање",
    ...
    noReviewLinks: "Линковите за оценување ќе се појават кога домаќинот ќе ги додаде.",
