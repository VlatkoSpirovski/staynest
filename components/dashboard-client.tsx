...
import { createManualPlaceDraft, draftFromGooglePlace, PlaceRecommendationForm, type PlaceRecommendationDraft } from "@/components/place-recommendation-form";
                ...
                <div className="grid gap-3 p-3 lg:p-4">
                  <GooglePlacePicker
                    ...
                    onSelect={(place) => {
                      setRecommendationDrafts((drafts) => [
                        ...drafts,
                        {
                          ...draftFromGooglePlace(place, defaultCategory, drafts.length + 1),
                  ...
                  {recommendationDrafts.length ? (
                    ...
                    <div className="rounded-[18px] border border-dashed border-[#172234]/14 bg-[#F9FAFB] px-4 py-8 text-center">
                      ...
                      <p className="mt-1 text-xs font-semibold text-[#111827]/48">Search Google Maps, select a result, add an optional host tip, then save.</p>
                      <button
                        type="button"
