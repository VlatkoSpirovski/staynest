...
import type { GeoapifyPlaceDetails } from "@/components/geoapify-place-picker";
...
export function draftFromGeoapifyPlace(place: GeoapifyPlaceDetails, fallbackCategory: PlaceRecommendationCategory, sortOrder: number): PlaceRecommendationDraft {
  return {
